package com.vibewithcodex.study.ddd.review

import com.vibewithcodex.study.ddd.review.application.EditReviewCommand
import com.vibewithcodex.study.ddd.review.application.ProductReviewSummaryProjector
...
import com.vibewithcodex.study.ddd.review.infra.InMemoryAsyncReviewEventPublisher
import com.vibewithcodex.study.ddd.review.infra.InMemoryProductReviewSummaryRepository
...
private fun awaitSummary(
    ...
    productId: String,
    condition: (ProductReviewSummary) -> Boolean,
